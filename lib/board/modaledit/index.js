...
function mapTableFormSet(e, f) {
    var field = {
        ...
        add: function () {
            field.formTypes.push({field: this.formname(), type: this.formtype(), label: this.formlabel(), 
                name: this.formname(), timestamp: Date.now()}); 
            field.formattrs.push({field: this.formname(), type: this.formtype(), label: this.formlabel(), 
                name: this.formname()}); 
            this.formname('');
            this.formfield('');
            this.formlabel('');
